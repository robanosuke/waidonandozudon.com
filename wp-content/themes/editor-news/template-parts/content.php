...
?>
	<div class="col-lg-4 col-md-12 col-sm-12">
		<article class="post grid-view-news-area vrsn-five wow animate fadeInUp" data-wow-delay=".3s" <?php post_class(); ?>>		
				   <?php 
			...
			?>		
					<figcaption class="post-content">
						...
						<div class="entry-content">
							...
							<a href="<?php the_permalink();?>" class="more-link"><?php echo esc_html(get_theme_mod('newsexo_read_more_button_text', __('Read More', 'editor-news'))); ?></a>
							<?php } ?>
							<?php wp_link_pages( array( 'before' => '<div class="page-links">' . __( 'Pages:', 'editor-news' ), 'after'  => '</div>', ) ); ?>
						</div>
					</figcaption>	
