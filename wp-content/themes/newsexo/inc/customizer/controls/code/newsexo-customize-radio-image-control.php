...
/**
 * Class NewsExo_Customize_Radio_Image_Control
 */
class NewsExo_Customize_Radio_Image_Control extends NewsExo_Customize_Base_Control {
	 ...
	 * @var    string
	 */
	public $type = 'newsexo-radio-image';
