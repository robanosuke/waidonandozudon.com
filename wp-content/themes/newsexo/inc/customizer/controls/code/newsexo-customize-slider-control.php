...
/**
 * Class NewsExo_Customize_Slider_Control
 */
class NewsExo_Customize_Slider_Control extends NewsExo_Customize_Base_Control {
	...
	protected function content_template() {
		...
		<div class="customize-control-content">
			<div class="newsexo-slider">
				<div id="custom-handle" class="ui-slider-handle"></div>
			</div>
			<div class="newsexo-slider-input">
				...
				<span class="slider-reset dashicons dashicons-image-rotate"><span
							class="screen-reader-text"><?php esc_html_e( 'Reset', 'newsexo' ); ?></span></span>
			</div>
		</div>
