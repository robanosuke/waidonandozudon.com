...
jQuery(document).ready(function () {
	...
	jQuery( "#customize-control-newsexo_trending_news_upgrade .newsexo-upgrade-pro-message" ).show();
	jQuery( "#customize-control-newsexo_news_slider_upgrade .newsexo-upgrade-pro-message" ).show();
	jQuery( "#customize-control-newsexo_featured_news_upgrade .newsexo-upgrade-pro-message" ).show();
	jQuery( "#customize-control-newsexo_you_have_missed_upgrade .newsexo-upgrade-pro-message" ).show();
    ...
    theme_conrols.on('click', '.customizer-repeater-new-field', function () {
		...
		if(parentid == 'customize-control-newsexo_top_header_social_content')
		{	
			var numItems = jQuery("#customize-control-newsexo_top_header_social_content .customizer-repeater-general-control-repeater-container").length 
			if(numItems >= 4){ 
			  jQuery( "#customize-control-newsexo_topheader_upgrade .newsexo-upgrade-pro-message" ).show();
			  return false;   
			}
		}
